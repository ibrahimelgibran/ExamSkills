                                ...
                                <?php else: ?>
                                    <?php if ($value->assignment_active == 1): ?>
                                        <label class="d-flex flex-md-row flex-column align-items-center cursor-pointer">
                                            <input type="checkbox" name="assignment_active" id="assignment_active<?= $value->id_assignment ?>" checked class="js-switch" onclick="forCheck('<?= $value->id_assignment ?>')" data-color="#0779FC" data-size="small">
                                            <span id="textLoading<?= $value->id_assignment ?>" style="display:none" class="text-muted d-inline-block">&nbsp;</span>
                                        </label>
                                    <?php else: ?>
                                        <label class="d-flex flex-md-row flex-column align-items-center cursor-pointer">
                                            <input type="checkbox" name="assignment_active" id="assignment_active<?= $value->id_assignment ?>" class="js-switch" onclick="forCheck('<?= $value->id_assignment ?>')" data-color="#0779FC" data-size="small">
                                            <span id="textLoading<?= $value->id_assignment ?>" style="display:none" class="text-muted d-inline-block">&nbsp;</span>
                                        </label>
                                    <?php endif ?>
                                <?php endif ?>
