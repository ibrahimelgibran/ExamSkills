        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <label class="d-flex flex-md-row flex-column align-items-center cursor-pointer">
                    <input type="checkbox" <?php if($dataAssignment->show_report == 1): echo "checked"; endif; ?> name="show_report" class="js-switch" data-color="#0779FC" data-size="small">
                    <span class="text-muted mr-l-20 d-inline-block">Tampilkan Hasil</span>
                </label>
            </div>
            <div class="col-sm-3">
                <label class="d-flex flex-md-row flex-column align-items-center cursor-pointer">
                    <input type="checkbox" <?php if($dataAssignment->show_analytic == 1): echo "checked"; endif; ?> name="show_analytic" class="js-switch" data-color="#0779FC" data-size="small">
