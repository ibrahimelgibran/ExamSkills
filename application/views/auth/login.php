...
<body class="body-bg-full profile-page">
	...
	<style>
        .login-left {
            background: url('<?= base_url("assets/img/b.png") ?>');
    ...
    <div id="wrapper" class="row wrapper">
        <div class="row container-min-full-height">
            ...
            <div class="col-lg-4 col-md-12 login-right d-lg-flex pos-fixed pos-right text-inverse container-min-full-height" style="background-color:#003470">
                <div class="login-content px-3 w-75 text-center">
                    <img src="https://ik.imagekit.io/elgibran/ieg.png?updatedAt=1721310901934" height="100" alt="" srcset="">
                    <h2 class="mb-4 text-center fw-300">Selamat Datang</h2>
					...
					<div class="text-center">
						<span class="text-white" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">made with ❤️ by iegcode</small>
					</div>
                    </form>
                    <!-- /form -->
                </div>
