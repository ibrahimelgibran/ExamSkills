...
<body class="header-dark sidebar-light sidebar-expand">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <footer class="footer"><span class="heading-font-family" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">made with ❤️ by iegcode</span>
        </footer>
    </div> <!--/ #wrapper -->
    <!-- Scripts -->
